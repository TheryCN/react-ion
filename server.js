...
app.post('/api/time/zone', function(req, res) {
  var data = [];
  var now = moment.utc(req.body.time, format);
  var tzList = ['Europe/Paris', 'Europe/London', 'Europe/Madrid', 'Europe/Berlin', 'Europe/Moscow', 'Canada/Atlantic',
    'America/Los_Angeles', 'America/New_York', 'Pacific/Auckland', 'Australia/Sydney', 'Asia/Tokyo', 'Asia/Kolkata'
  ];
